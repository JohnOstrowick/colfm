...
inline void populateSidebar() {
    ...
    // helper to build a row widget (icon + label)
    ...
    // Home (top-level, expandable; clicking arrow reveals child folders)
    ...
    sidebar->setItemWidget(homeItem, 0, makeRow("Home", home + "./", /*isDrive*/false));
    ...
    QObject::connect(sidebar, &QTreeWidget::itemClicked, this,
        [this, trashItem](QTreeWidgetItem *clicked, int){
